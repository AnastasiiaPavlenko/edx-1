...
ES6_sayMessage();
ES6_sayMessage("This is a DEFFERENT message!");
...
class Language {
    ...
    summary(){
       // return this.name + " was created by " + this.founder + " in " + this.year;
        return `${this.name} was created by ${this.founder} in ${this.year}`;//шаблонная строка
...
let myPromise = new Promise(
    (fResolve, fReject) =>{
        console.log("Look here, I am starting!");
